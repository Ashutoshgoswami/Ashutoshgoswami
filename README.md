...
<ul>
  <li>🔍 <b>Foreign Object Debris (FOD) Detection System:</b> Developed using YOLO and CNN models, applied for drone imagery analysis.</li>
  <li>🌐 <b>Interactive Weather Dashboard:</b> Created a responsive weather dashboard with real-time data and visualizations.</li>
  <li>🗂️ <b>NLP-based Legal Document Processor:</b> Designed an NLP system for extracting key information from lengthy legal documents.</li>
</ul>
